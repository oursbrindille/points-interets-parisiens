...
sudo -u postgres psql -d paris -c "\copy objet(nom, startYear, endYear, prod) TO '/home/geof/projects/monuments-paris/csv/postgres/objet.csv' DELIMITER ',' CSV HEADER;"
